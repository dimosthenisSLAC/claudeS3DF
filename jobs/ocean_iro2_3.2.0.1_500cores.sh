...
echo "=== OCEAN 3.2.0.1: IrO2 Ir L-edge — 480 cores (4 nodes) scaling test ==="
echo "Date: $(date)"
...
WORKDIR="/sdf/scratch/users/d/dsokaras/ocean321_500c_${SLURM_JOB_ID}"
mkdir -p "$WORKDIR"
cd "$WORKDIR"
...
echo "=========================================="
echo "  Running OCEAN 3.2.0.1 — 480 cores / 4 nodes"
echo "=========================================="
T0=$(date +%s)
...
# Copy results
RESULT_DIR="$HOME/claudeS3DF/results/ocean_iro2_scaling/480cores"
mkdir -p "$RESULT_DIR"

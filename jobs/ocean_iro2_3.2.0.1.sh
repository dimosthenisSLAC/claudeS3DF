...
echo "=== OCEAN 3.2.0.1: IrO2 Ir L-edge ==="
echo "Date: $(date)"
...
WORKDIR="/sdf/scratch/users/d/dsokaras/ocean321_iro2_${SLURM_JOB_ID}"
mkdir -p "$WORKDIR"
cd "$WORKDIR"
...
echo "=========================================="
echo "  Running OCEAN 3.2.0.1 — IrO2 Ir L-edge"
echo "=========================================="
T0=$(date +%s)
...
# Copy results
RESULT_DIR="$HOME/claudeS3DF/results/ocean_iro2_3.2.0.1"
mkdir -p "$RESULT_DIR"
